...
categoryDisplay.textContent = "Phonemic Awareness"
contentDisplay.textContent = "Listen & Choose"
...
ttsConvertButton.addEventListener("click", async () => {
    ...
    try {
        ...
        // Generate new speech
        await keyWordTtsObj.generateSpeech(questionInput.value, ttsId.toString(), 2, voiceId);
