...
function checkInputState() {
    ...
    const hasStartedEditing = getQuestion || getAnswer || hasAudio || getChoices.some(choice => choice.value.trim() !== "") || getPrefixSuffix || getPrefixSuffixMeaning;
        ...
        try{
            ...
            if (selectedContentId) {
                ...
                selectedContent.content_json.forEach((questionNo) => {
                    questionObject.push({
                        prefixSuffix: questionNo.prefixSuffix,
                        prefixSuffixMeaning: questionNo.prefixSuffixMeaning,
                        question: questionNo.question,
                        choices: questionNo.choices,
                        answer: questionNo.answer
                    });
                    console.log('Prefix/Suffix', questionNo.prefixSuffix);
                    console.log('Meaning', questionNo.prefixSuffixMeaning);
